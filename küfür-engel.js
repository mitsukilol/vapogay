...
exports.run = async (client, message) => {
  ...
  const db = require('quick.db');
	...
	if(secenekler.length < 1) return message.reply(`**q!küfür-engelle aç** veya **q!küfür-engelle kapat** yazınz `);
  ...
  if (secenekler !== "aç" && secenekler !== "kapat" && secenekler !== "on" && secenekler !== "off") return message.reply(`**q!küfür-engelle aç** veya **q!küfür-engelle kapat** yazınz `)
    ...
    .setColor('RED')
    .setDescription(`Küfür Engeli Başarıyla açıldı\nKüfür engelini kapatmak isterseniz **q!küfür-engel kapat** yazmanız yeterlidir.`)
